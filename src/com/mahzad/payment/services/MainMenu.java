...
public class MainMenu {
    ...
    public void start() {
        try {
            ...
            System.out.println(1 + ". Payment Services");
            System.out.println(2 + ". Report");

            System.out.println("Please return you desired service code: ");
            int selectedServiceCode = Integer.parseInt(scanner.nextLine());

            if (selectedServiceCode == 1)
                paymentService();
            else if (selectedServiceCode == 2)
                reportService();
            else {
                System.out.println("Your service code is invalid. ");
                start();
            }
        } catch (IOException e) {
    ...
    private void reportService() throws IOException {
